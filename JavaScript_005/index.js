...
// console.log(car.push('yellow'));

// let fourthElement = car.push('yellow', 5, {greeting: "Hi ik ben een object"})
// console.log(car)

// let lastElement = car[car.length-1];
...
// const lastBreed = catBreeds[catBreeds.length-1]
